...
const JoinPage = () => {
    ...
    return (
        <div className="h-full flex flex-col gap-y-8 items-center justify-center p-8 rounded-lg shadow-md">
            <Image src={"/logo.jpg"} width={80} height={80} alt="logo" className="text-white"/>
            <div className="flex flex-col gap-y-4 items-center justify-center max-w-md">
                ...
                length={6}
                    classNames={{
                        container: cn("flex gap-x-2 border-primary", isPending && "opacity-50 cursor-not-allowed"),
                        ...
                        characterSelected: "bg-black text-white",
                        characterFilled: "bg-black text-white"
                    }}
                    autoFocus
                />
            </div>
