...
export const PrefrencesModal = ({open,setOpen, initialValue}: PrefrencesModalProps) => {
                ...
                <div className="px-4 pb-4 flex flex-col gap-y-2">
                    ...
                    <DialogContent>
                        ...
                        <form className="space-y-4" onSubmit={handleEdit}>
                            <Input value={value} disabled={isUpdatingWorkspace} onChange={(e) => setValue(e.target.value)} required autoFocus minLength={3} maxLength={80} placeholder="New workspace name" />
                        <DialogFooter>
                            <DialogClose asChild>
