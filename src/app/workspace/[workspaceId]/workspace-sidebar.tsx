...
export const WorkspaceSidebar = () => {
    ...
    if(workspaceLoading || memberLoading){
        return(
            <div className="flex flex-col bg-[#32a3ad] h-screen items-center justify-center">
    ...
    if(!member || !workspace){
        return(
            <div className="flex flex-col gap-y-2 bg-[#32a3ad] h-screen items-center justify-center">
    ...
    return(
        <div className="flex flex-col bg-[#32a3ad] h-full">
